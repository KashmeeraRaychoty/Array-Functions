...
function findEmployeeById(empid)   {
    const obj = employees.find(o => o.id === empid)
    if(typeof(obj) == "object")
        console.log(obj)
    else
        console.log("No employee with id", empid)
}

findEmployeeById("10");

function findEmployee(key, value)   {
    const obj = employees.find(o => o[key] === value)
    if(typeof(obj) == "object")
        console.log(obj)
    else
...
updateEmployeeById("3", "name", "Shreya")
...
function deleteEmployeeById(empid)  {
    ...
    if(index !== -1)    {
        console.log("Removed element: ", employees[index]);
        var spliced = employees.splice(index, 1);
        console.log("Remaining elements: ", employees);
    }
}
